# -------------------------------------------------------------------------#
# Example with extravascular SD data TAU=24 (linlog) ----
...
cat("Theoph LinearUp LogDown\n")

dataNCA <- IQdataNCA(data = data,FLAGTIME = "actual",AUCMETHD = "LinearUp LogDown",FLAGignore = FALSE)

resNCA <- nca_IQdataNCA(data = dataNCA)
