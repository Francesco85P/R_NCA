...
c_libfile_base = "ubiquity_5b88b1cb80548d5d9acc2b3edf7e5ce7"
...
cfg[["options"]][["misc"]][["temp_directory"]] = './transient/5b88b1cb80548d5d9acc2b3edf7e5ce7'
cfg[["options"]][["misc"]][["distribution"]]   = 'package'
cfg[["options"]][["misc"]][["system_file"]]    = 'system.txt'
...
cfg[["parameters"]][["matrix"]] = data.frame(stringsAsFactors=TRUE, 
   name         = c("PNAME"),
   value        = c(1.0),
   lower_bound  = c(.Machine$double.eps),
   upper_bound  = c(Inf),
   ptype        = c("system"),
   editable     = c("yes"),
   type         = c("System"),
...
# defining indices
# states   
cfg[["options"]][["mi"]][["states"]] = list()
cfg[["options"]][["mi"]][["states"]][["TMP"]]          = 1 
# outputs  
cfg[["options"]][["mi"]][["outputs"]] = list()
cfg[["options"]][["mi"]][["outputs"]][["TMP_OBS"]]      = 1 
# parameters  
cfg[["options"]][["mi"]][["parameters"]] = list()
cfg[["options"]][["mi"]][["parameters"]][["PNAME"]]        = 1 


# odes     
cfg[["options"]][["mi"]][["odes"]]    = list()
cfg[["options"]][["mi"]][["odes"]][["TMP_OBS"]]      = 1 
cfg[["options"]][["mi"]][["odes"]][["PNAME"]]        = 2 
cfg[["options"]][["mi"]][["odes"]][["ts.time"]]      = 3 
cfg[["options"]][["mi"]][["odes"]][["ts.sys_time"]]  = 4 


# Parameter Sets
cfg[["parameters"]][["sets"]][["default"]] = list(name=NULL, values=NULL)
...
cfg[["options"]][["time_scales"]][["sys_time"]]     = 1.0
...
cfg[["options"]][["misc"]][["nonmem"]] = 'HASH(0x555563469530)' ;
cfg[["options"]][["misc"]][["amtify"]] = 'HASH(0x5555635fe4f8)' ;
